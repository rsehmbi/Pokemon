...
/**
 * Shows all the tokimons using
 * Height
 * Weight
 * Strength
 * As selected by the user
 */
public class ViewAllTokimons {
    ...
    ViewAllTokimons() throws FileNotFoundException {
    ...
    private void makeBarGraph() {
        for (int i = 0; i < tokimontoParse.length; i++) {
            ...
            series.getData().add(new XYChart.Data(tokimontoParse[i].getName(), tokimontoParse[i].getStrength()));
